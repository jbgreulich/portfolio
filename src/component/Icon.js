...
import { babelIconAbout, babelIconModal, couchIconAbout, couchIconModal, mochaIconAbout, mochaIconModal, postgresqlIconAbout, railsIconAbout, reduxIconAbout, reduxIconModal, rubyIconAbout, sqliteIconAbout, sqliteIconModal, webpackIconAbout, webpackIconModal } from './icons';
...
export default class Icon extends Component {
  renderIcon = () => {
    ...
    switch (displayIcon) {
      ...
      case 'postgresql-about': return <img className='fab modal-icon' src={postgresqlIconAbout}></img>;
      case 'rails-about': return <img className='fab modal-icon' src={railsIconAbout}></img>;
      case 'redux-about': return <img className='fab modal-icon' src={reduxIconAbout}></img>;
      case 'ruby-about': return <img className='fab modal-icon' src={rubyIconAbout}></img>;
      ...
      case 'redux': return <img className='fab modal-icon' src={reduxIconModal}></img>;
